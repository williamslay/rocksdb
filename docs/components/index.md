...
| Compaction | [compaction/index.md](compaction/index.md) | Chinese compaction guide: scheduling, picking, styles, I/O, key reduction, execution, installation, cleanup, observability, and QA. |
